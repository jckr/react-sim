...
export function initData(params: ChaosParams): ChaosData {
...
export function updateData(args: {
  ...
  params: ChaosParams;
  tick: number;
  cachedData: Record<number, ChaosData>;
}): UpdateResult<ChaosData> {
...
export const module: SimulationModule<ChaosData, ChaosParams, ChaosRenderState, unknown> = {
  initData,
  updateData,
